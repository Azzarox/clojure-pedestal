...
(defproject pedrepl "0.0.1-SNAPSHOT"
  ...
  :dependencies [[org.clojure/clojure "1.10.1"]
                 ...
                 ;; [io.pedestal/pedestal.immutant "0.6.5"]
                 ;; [io.pedestal/pedestal.tomcat "0.6.5"]
  ...
  :profiles {:dev {:aliases {"run-dev" ["trampoline" "run" "-m" "pedrepl.server/run-dev"]}
                   :dependencies [[io.pedestal/pedestal.service-tools "0.6.5"]]}
